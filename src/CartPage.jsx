...
const SingleCartProduct = ({ cart, idx }) => {
  ...
  return (
    <div className="w-full flex justify-between p-5 my-4 m-4">
      <div className="flex justify-center items-center w-32  border-1 rounded-lg"> <div className="flex rounded-lg justify-center items-center overflow-hidden"><img className='w-24 h-fit object-cover' src={cart.imageUrl} /></div></div>
